...
#             'filed':fileduse
#         }
#         return render(request, 'confgrate/users.html', context)
...
#        # return render(request,'books/book-create.html',{'from':from})


class RegisterView(View):
    form_class = RegisterForm
    initial = {'key': 'value'}
    template_name = 'confgrate/users.html'
...
class UserDatatJson(BaseDatatableView):
    ...
    def render_column(self, row, column):
        if column =="id":
            ...
            return super(UserDatatJson, self).render_column(row, column)
